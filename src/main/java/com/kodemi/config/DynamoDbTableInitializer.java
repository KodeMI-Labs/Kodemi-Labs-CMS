...
public class DynamoDbTableInitializer {
    ...
    private static final List<String[]> TABLES = List.of(
            ...
            new String[]{"ContactUs",                "contact_id"},

            // ── Dynamic Learner Preferences (Sub Admin side) ───────────────────
            new String[]{"PreferenceJourney",        "journey_id"},
            new String[]{"PreferencePage",           "page_id"},
            new String[]{"PreferenceOption",         "option_id"},
            new String[]{"PreferenceRule",           "rule_id"},
            new String[]{"PreferenceJourneyVersion", "version_id"},
            new String[]{"PreferenceRecommendation", "recommendation_id"},

            // ── Learner Preferences (Learner side) ─────────────────────────────
            new String[]{"LearnerPreference",        "learner_id"},
            new String[]{"LearnerJourneyProgress",   "progress_id"}
    );
